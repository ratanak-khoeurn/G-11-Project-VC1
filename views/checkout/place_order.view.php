...
<div class="col-md-8 mb-3" style="display:flex; flex-direction:column; justify-content:center; align-items: center; margin-left: 16%; margin-top:20px; height: 100%;">
    <div id="checkout" style="width: 100%; height: 50%;">
        <div class="osahan-cart-item mb-3 rounded shadow-sm bg-white overflow-hidden" style="height:100%">
                        ...
                        <div class="custom-control col-lg-6 custom-radio mb-3 position-relative border-custom-radio">
                            ...
                            <label class="custom-control-label w-100" for="customRadioInline1">
                                <div style="height:250px">
                                    ...
                                    <div class="Edit" style="margin-top:100px;">
...
<div class="payment" style="background-color:teal; width: 65.8%; margin-left:16.5%; border-radius:10px; margin-bottom:10px">
    <a class="btn btn-success btn-block btn-lg" href="/successfull.html">PAY $1329<i class="feather-arrow-right"></i></a>
</div>
</div>