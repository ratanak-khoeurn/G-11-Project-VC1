                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body" style="height: 400px">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="cc-number" type="tel" name="card_number"
                                                        class="input-lg form-control cc-number"
                                                        autocomplete="cc-number"
                                                        placeholder="&bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull; &bull;&bull;&bull;&bull;"
                                                        required>
                                                        <small id="cc-number-error" class="text-danger">Credit card number is invalid.</small>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <button type="submit" id="payNowButton"
                                                            style="background-color: #E21B70; color: white"
                                                            class="btn btn-lg btn-block">Pay Now</button>
