    ...
    <div class="login-page">
        ...
        <div id="myModal" class="modal">
            <div class="modal-content">
                ...
                <form action="controllers/signin/check_signin_manager.controller.php" method="post">
        ...
        <div class="text">
            <h1>WELCOME TO <span>Manager</span></h1>
            <p>Your one-stop destination for online food ordering</p>
            <p>If you are the manager please Signin here:</p>
